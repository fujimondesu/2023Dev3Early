    ...
    <div class="container text-center">
        <div class="row justify-content-center">
            <form class="border rounded bg-white col-md-4 p-3">
                <h2 class="mt-3 mb-5" style="color: #000000; font-family: cursive;">ログイン</h2>
                <div class="mb-3">
                ...
                <div>
                  <input type="checkbox" name="check" value="情報の保存"/>情報を保存しますか？
                </div>
                <a href="./home.html">
                  <button type="button" class="btn btn-primary rounded-pill my-4 px-5">ログイン</button>
                </a>
                <div>
                  <a href="./forget_password.html">
                    <button type="button" class="btn btn-link">パスワードを忘れた方はこちら</button>
                  </a>
                </div>
                <div>
                  <a href="./sign_up.html">
